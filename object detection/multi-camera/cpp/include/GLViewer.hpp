...
public:
    ...
    void updateObjects(sl::Objects &objs,std::map<sl::CameraIdentifier, sl::Objects>& singldata, sl::FusionMetrics& metrics);
...
private:
    ...
    void addObject(sl::ObjectData &obj, Simple3DObject &simpleObj, sl::float3 clr_id, bool raw);
