...
public:
    ...
    void init(sl::Mat &);
    void updatePc(sl::FusedPointCloud&);
    void updateMesh(sl::TerrainMesh&, sl::REFERENCE_FRAME = sl::REFERENCE_FRAME::CAMERA);
...
private:
    ...
    std::mutex mtx;
    bool draw_wire_frame = false;
    CameraGL camera_;

    ShaderObj shader_fpc, shader_clr_fix, shader;
    ...
    PointCloud pc;
    std::vector< Simple3DObject> floor_grid;
    Simple3DObject axis;
    bool camera_centric_terrain = true;
